...
<body id="body_background">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-9">
          <h2 class="text-center shadow-lg text-uppercase">All Categories</h2>
          <div class="table-responsive" style="color: ; background: #37B5B6;">
            ...
            ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($category['category_status']); ?></td>
                    <td><?php echo htmlspecialchars($category['created_at']); ?></td>
                    <td><?php echo htmlspecialchars($category['updated_at']); ?></td>
                    <td><?php echo htmlspecialchars($category['category_status']); ?></td>
                    <td><input type='submit' name='edit_category' value='Edit'></td>
                    <td>|</td>
                    <td><a href="add_category.php"><input type='submit' name='add_category' value='Add'></a></td>
                  </tr>
              <?php
                  }
              }
