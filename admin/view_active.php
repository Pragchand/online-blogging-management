	...
	<div class="container-fluid">
        ...
        <div class="col-md-9">
            ...
            <div class="table-responsive" style="color: ; background: #37B5B6;">
                <table id="table_id" class="display">
                    ...
                    $query = "SELECT * FROM user WHERE is_approved = 'Approved' AND is_active='Active' ORDER BY user_id DESC";
                    ...
                    if ($result->num_rows > 0) {
                     ...
                     ?>
                        <tr>
                            ...
                            <td> <a href="?inactive=<?= $user['user_id'] ?>"><input type='submit' name='inactive' value='InActive'></a></td>
                        </tr>
                        <?php
                        }
                    }
        ...
        <?php 
            if(isset($_REQUEST['inactive'])){
                $query = "SELECT * FROM user WHERE user_id='".$_REQUEST['inactive']."'";
                $result = mysqli_query($connection,$query);
                if($result)
                {
                ...
                $query = "UPDATE user
                      ...
                      WHERE user_id = '".$_REQUEST['inactive']."'";
            $result = mysqli_query($connection, $query);
