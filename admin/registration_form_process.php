...
if (isset($_POST['register'])) {
    ...
    if ($flag=== true) {
        ...
        $query = "INSERT INTO user(role_id, first_name, last_name, email, password, gender, date_of_birth, address, user_image, is_approved, is_active) 
                  VALUES('$role', '$first_name', '$last_name', '$email', '$password', '$gender', '$date_of_birth', '$address', '$path', 'Approved', '$is_active')";
        ...
        if (mysqli_query($connection, $query) === TRUE) {
            ...
            header("Location: registration_form.php?message=Registration Successful.");
            exit();
        } else {
...
if (isset($_POST['update'])) {
    ...
    if ($result) {
        header("Location: manage_user.php?message=Record Updated Successfully");
    } else {
        header("Location: manage_user.php?message=Record Not Updated...!");
    }
}
?>
